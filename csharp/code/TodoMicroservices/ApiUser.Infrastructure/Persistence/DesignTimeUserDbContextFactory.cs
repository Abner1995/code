...
class DesignTimeUserDbContextFactory : IDesignTimeDbContextFactory<UserDbContext>
{
    public UserDbContext CreateDbContext(string[] args)
    {
        // 获取当前解决方案的根目录（或手动指定主项目路径）
        var basePath = Path.GetFullPath(
            Path.Combine(AppContext.BaseDirectory, "..", "..", "..", "..", "ApiUser")
        );
        ...
        return new UserDbContext(builder.Options, null!, null!);
    }
}
