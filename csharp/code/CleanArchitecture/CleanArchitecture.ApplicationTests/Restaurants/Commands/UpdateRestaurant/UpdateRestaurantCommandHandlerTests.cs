...
namespace CleanArchitecture.Application.Restaurants.Commands.UpdateRestaurant.Tests;
...
public class UpdateRestaurantCommandHandlerTests
{
    ...
    public async Task Handle_WithValidRequest_ShouldUpdateRestaurants()
    {
        ...
        _restaurantsRepositoryMock.Setup(r => r.GetIdAsync(restaurantId))
    ...
    public async Task Handle_WithUnauthorizedUser_ShouldThrowForbidException()
    {
        ...
        _restaurantsRepositoryMock
            .Setup(r => r.GetIdAsync(restaurantId))
