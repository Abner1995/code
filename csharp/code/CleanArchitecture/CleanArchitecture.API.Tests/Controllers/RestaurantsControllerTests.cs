using CleanArchitecture.API.Tests;
...
namespace CleanArchitecture.API.Controllers.Tests;
...
public class RestaurantsControllerTests
{
    ...
    public async Task GetById_ForNonExistingId_ShouldReturn404NotFound()
    {
        ...
        _restaurantsRepositoryMock.Setup(m => m.GetIdAsync(id)).ReturnsAsync((Restaurant?)null);
    ...
    public async Task GetById_ForExistingId_ShouldReturn200Ok()
    {
        ...
        _restaurantsRepositoryMock.Setup(m => m.GetIdAsync(id)).ReturnsAsync(restaurant);
